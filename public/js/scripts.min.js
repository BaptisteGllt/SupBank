...
var CustomSelect = function($) {
    var defaults = {
        ...
        CustomSelect = function() {
            ...
            return _proto._init = function() {
                var _this = this;
                this._$element = $('<div class="' + this._options.block + '">\n           <button class="' + this._options.block + "__option " + this._options.block + '__option--value" type="button"></button>\n           <div class="' + this._options.block + '__dropdown" style="display: none;"></div>\n         </div>'), this._$select.hide().after(this._$element), this._options.modifier && this._$element.addClass(this._options.modifier), this._$values = this._$select.find("option"), this._values = [], $.each(this._$values, function(i, option) {
                    var el = $(option).text().trim();
                    _this._values.push(el)
                }), this._$value = this._$element.find("." + this._options.block + "__option--value"), this._options.placeholder && (this._$select.find("[selected]").length ? this._options.placeholder = !1 : (this._$value.html(this._options.placeholder), this._$select.prop("selectedIndex", -1))), this._$dropdown = this._$element.find("." + this._options.block + "__dropdown"), $.each(this._values, function(i, el) {
            ...
            }, CustomSelect._jQueryPlugin = function(options) {
                return this.each(function() {
                    var $this = $(this),
                        data = $this.data("custom-select");
                    data || (data = new CustomSelect(this, options), $this.data("custom-select", data))
                })
            }, CustomSelect
        }();
...
$(function() {
	$(document).ready(function() {
        ...
        $(function() {
            var firstUrlName = location.pathname.split('/')[1];
            switch (firstUrlName) {
                case 'wallet':
        ...
        $('#add-new-wallet').on('click', function(){
            $('#popup-new-wallet').removeClass('d-none');
        });
        $('#send-supcash').on('click',function () {
            $('#popup-send-supcash').removeClass('d-none');
        });
        $('#edit-wallet').on('click',function () {
            $('#popup-edit-wallet').removeClass('d-none');
        })
        $(document).on('keydown', function ( e ) {
            if ( e.keyCode === 27 ) { // ESC
                $('#popup-new-wallet').addClass('d-none');
                $('#popup-send-supcash').addClass('d-none');
                $('#popup-edit-wallet').addClass('d-none');
                //window.location.replace('wallet');
            }
        });
        $('#close-popup-wallet').on('click', function() {
            $('#popup-new-wallet').addClass('d-none');

        });
        $('#close-popup-send-sc').on('click', function() {
            $('#popup-send-supcash').addClass('d-none');

        });
        $('#close-popup-edit-wallet').on('click', function() {
            $('#popup-edit-wallet').addClass('d-none');

        });
        $('.button-prevent-multiple-submits').on('click', function() {
            $('.button-prevent-multiple-submits').css('cursor', 'not-allowed');
