                ...
                <form action="/settings" method="POST" class="form settings-form">
                    ...
                    <div class="form__row">
                        ...
                        <div class="form__col-xl">
                            ...
                            <div class="input-wrap">
                                <input type="text" name="user_address" value="{{ Auth::user()->user_address }}">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        @foreach ($wallets as $wallet)
                            <div class="col-sm-6">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">{{$wallet->name}} wallet</h5>
                                        <samp>{{$wallet->private_key}}</samp>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="wallet__list">
                    @foreach ($wallets as $wallet)
                        ...
                        <div class="wallet__item__course">
                            <span>{{$wallet->solde}} SC</span>
                            {{$wallet->solde *36}} €
                        </div>
                            <form autocomplete="off" enctype="multipart/form-data" action="{{ action('SettingsController@deleteWallet') }}" method="POST"  id="wallet-deletion">
                                <input type="hidden" name="_token" value="{{csrf_token()}}">
                                <input type="hidden" name="walletNumber" value="{{$wallet->num_wallet}}">
