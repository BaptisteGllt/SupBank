...
<head>
    ...
    <script src="../js/p2p-graph.min.js"></script>
        ...
        <div>
            ...
            <header class="header">
                ...
                <div class="inner-col">
                    ...
                    <a style="color: rgba(0,0,0,.9); margin-left: 30px;" class="navbar-brand" href="{{ url('/') }}">
                        {{ config('app.name', 'Laravel') }} <span class="caret"></span>
                        <img src="../img/favicon.ico" alt="home" style="width: 20px; height: 20px; margin-right: 30px;">
                    </a>
                        ...
                        <div class="user">
                            ...
                            <ul class="user-menu">
                                <li class="user-menu__item">
                                    <a href="{{ url('/settings') }}" class="user-menu__link">
                        <span href="{{ url('/settings') }}" class="user-menu__icon">
                                 ...
                                 width="18px" height="18px" viewBox="0 0 18 18" style="enable-background:new 0 0 18 18;" xml:space="preserve">
                                   <path d="M9,6C7.343,6,6,7.343,6,9c0,1.657,1.343,3,3,3c1.657,0,3-1.343,3-3C12,7.343,10.657,6,9,6z M9,10.5
                                       ...
                                       c0.414,0,0.75,0.336,0.75,0.75S16.164,9.75,15.75,9.75z"/>
                                        ...
                                        <span href="{{ url('/settings') }}" class="user-menu__text">
                            Settings
                        </span>
                                    </a>
                                </li>
                                <li class="user-menu__item">
                                    <a href="{{ url('/logout') }}" onclick="event.preventDefault();
                                         document.getElementById('logout-form').submit();" class="user-menu__link">
                        <span href="{{ url('/logout') }}" onclick="event.preventDefault();
            ...
            <div class="content">
                <aside class="sidebar">
                    ...
                    <ul class="menu">
                        <li id="wallet-link" class="menu__item">
                            <a class="menu__link" href="{{ url('/wallet') }}">
                <span class="menu__link-icon">
                    ...
                    Wallet
                        ...
                        <li id="transactions-link" class="menu__item">
                            <a class="menu__link" href="{{ url('/transactions') }}">
                <span class="menu__link-icon">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                   ...
                   <path d="M27.858,19.159H20.79l2.003-2.003c0.264-0.264,0.264-0.694,0-0.958
                    ...
                    Transactions
                        ...
                        <li id="buysale-link" class="menu__item">
                            <a class="menu__link" href="{{ url('/buy') }}">
                <span class="menu__link-icon">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                ...
                <li id="network-link" class="menu__item">
                    <a class="menu__link" href="{{ url('/network') }}">
                    <span class="menu__link-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 79.79 79.9"><defs><style>.a{fill:#696969;}</style></defs><title>tt</title><path class="a" d="M42.5,10.5c-1.4,1.3-2.5,3-2.5,3.7s-4.2,3.4-9.4,6c-7.9,3.9-9.9,4.6-13.4,4.1s-4.4-.1-6.6,2c-3.4,3.5-3.4,7.9,0,11.4,2.2,2.1,3.2,2.5,6.6,2s5.5.2,13.4,4.1C35.8,46.4,40,49,40,49.6a9.68,9.68,0,0,0,2,3.7c1.6,2.1,2,4,2,11.1,0,4.7-.2,8.6-.5,8.6C41.6,73,24,63.3,24,62.2c0-2.5-4.8-6.2-8-6.2-7.1,0-10.5,8.6-5.4,13.7,2.2,2.1,3.2,2.5,6.6,2,5.8-.8,21.6,7,23.8,11.7a7.69,7.69,0,0,0,14,0c2.2-4.7,18-12.5,23.8-11.7,3.4.5,4.4.1,6.6-2C90.5,64.6,87.1,56,80,56c-3.2,0-8,3.7-8,6.2C72,63.3,54.4,73,52.5,73c-.3,0-.5-3.9-.5-8.6,0-7.1.4-9,2-11.1a9.68,9.68,0,0,0,2-3.7c0-.6,4.2-3.2,9.4-5.8,7.9-3.9,9.9-4.6,13.4-4.1s4.4.1,6.6-2C90.5,32.6,87.1,24,80,24c-3.2,0-8,3.7-8,6.2,0,.8-3.9,3.3-8.7,5.7-12.3,6.1-17.6,6.3-29,.7C29.7,34.4,26,32.3,26,32s3.8-2.4,8.4-4.7c6.9-3.5,9-4.1,12.4-3.6s4.4.1,6.6-2c3.4-3.4,3.4-7.9.1-11.2a7.3,7.3,0,0,0-11,0Z" transform="translate(-8.05 -8)"/></svg>
                    </span>
                        <span class="menu__link-text">
                        P2P
                    </span>
                        ...
                        <li id="settings-link" class="menu__item">
                            <a class="menu__link" href="{{ url('/settings') }}">
                <span class="menu__link-icon">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                         width="18px" height="18px" viewBox="0 0 18 18" style="enable-background:new 0 0 18 18;" xml:space="preserve">
                           <path d="M9,6C7.343,6,6,7.343,6,9c0,1.657,1.343,3,3,3c1.657,0,3-1.343,3-3C12,7.343,10.657,6,9,6z M9,10.5
                    ...
                    <div class="d-md-none">
                        ...
                        <span href="{{ url('/settings') }}" class="user-menu__icon">
                            ...
                            Settings
                                ...
                                <li class="user-menu__item">
                                    <a href="{{ url('/logout') }}" class="user-menu__link">
                        <span href="{{ url('/logout') }}" onclick="event.preventDefault();
                                         document.getElementById('logout-form').submit();" class="user-menu__icon">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                 width="9.467px" height="11px" viewBox="0 0 9.467 11" style="enable-background:new 0 0 9.467 11;" xml:space="preserve">
