    ...
    <body>
        ...
        <header class="header-section clearfix">
            <div class="container-fluid">
                ...
                <a href={{url('/settings')}} class="user"><i class="fa fa-user"></i></a>
                <nav class="main-menu">
                    <ul class="menu-list">
                        @auth
                ...
                <div class="row">
                    <div class="col-md-6 hero-text">
                        ...
                        <form class="hero-subscribe-from">
                            <a href="{{ url('/register') }}" class="site-btn sb-gradients">Get Started</a>
                        </form>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 offset-lg-6 about-text">
                        ...
                        <a href="{{ url('/register') }}" class="site-btn sb-gradients sbg-line mt-5">Get Started</a>
                    </div>
                </div>
                <div class="about-img">
