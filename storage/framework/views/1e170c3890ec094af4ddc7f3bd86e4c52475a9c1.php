    ...
    <body>
        ...
        <header class="header-section clearfix">
            <div class="container-fluid">
                ...
                <a href=<?php echo e(url('/profile')); ?> class="user"><i class="fa fa-user"></i></a>
                <nav class="main-menu">
                    <ul class="menu-list">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 hero-text">
                        <h2>Invest in <span>SupCash</span> <br>SupCash Trading</h2>
                        <h4>Use modern progressive technologies of SupCash to earn money</h4>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 offset-lg-6 about-text">
                        ...
                        <h5>SupCash is an innovative payment network and a new kind of money.</h5>
                        <p>SupCash is one of the most important inventions in all of human history. For the first time ever, anyone can send or receive any amount of money with anyone else, anywhere on the planet, conveniently and without restriction. It’s the dawn of a better, more free world.</p>
        ...
        <section class="process-section spad">
            <div class="container">
                <div class="section-title text-center">
                    <h2>Get Started With SupCash</h2>
                    <p>Start learning about SupCash with interactive tutorials. It’s fun, easy, and takes only a few minutes! </p>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-8 push-8">
                        ...
                        <div class="review-text-slider owl-carousel">
                            <div class="review-text">
                                <p>"SupCash is exciting because it shows how cheap it can be. SupCash is better than currency in that you don’t have to be physically in the same place and, of course, for large transactions, currency can get pretty inconvenient.”</p>
                            </div>
                            <div class="review-text">
                                <p>"SupCash is exciting because it shows how cheap it can be. SupCash is better than currency in that you don’t have to be physically in the same place and, of course, for large transactions, currency can get pretty inconvenient.”</p>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="blog-item">
                            ...
                            <div class="blog-text">
                                ...
                                <h4 class="blog-title"><a href="">Coinbase to Reopen the GDAX SupCash Cash-Euro Order Book</a></h4>
                                <div class="post-meta">
                    ...
                    <div class="col-md-4">
                        <div class="blog-item">
                            ...
                            <div class="blog-text">
                                ...
                                <h4 class="blog-title"><a href="">This Week in SupCash: Up, Down and Sideways</a></h4>
                                <div class="post-meta">
                                    <a href=""><span>by</span> Admin</a>
                                    <a href=""><i class="fa fa-heart-o"></i> 234 Likes</a>
                                    <a href=""><i class="fa fa-comments-o"></i> 08 comments</a>
