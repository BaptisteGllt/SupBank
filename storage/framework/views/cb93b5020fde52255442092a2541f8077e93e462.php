            ...
            <div class="row">
                <div class="col col--md-auto">
                    ...
                    <form class="authorization__form" method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="input-wrp">
                            <div class="g-recaptcha" style="text-align: -webkit-match-parent;"  type="g-recaptcha-response" name="g-recaptcha-response" data-sitekey="<?php echo e(env('CAPTCHA_KEY')); ?>"></div>
                            <input class="form-control form-control<?php echo e($errors->has('g-recaptcha-response') ? ' is-invalid' : ''); ?>"hidden>
                        ...
                        <p>
                            <label class="checkbox">
                                ...
                                <i class="fontello-check"></i><span>I agree with <a href="<?php echo e(url('/terms')); ?>">Terms of Services</a></span>
                            </label>
