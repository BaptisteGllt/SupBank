<?php $__env->startSection('content'); ?>
        ...
        <main class="main-content">
            <div class="wallet-inner">
                <div class="wallet-inner__header">
                    <h2><?php echo e($walletDetails->name); ?></h2>
                </div>
            </div>
            <div class="wallet-inner__row">
                <div class="wallet-inner__col">
                    <div class="wallet wallet--full-width" style="background-color: #158EBD;">
							...
							<span class="wallet__header">
								<span class="wallet__currency">
									...
									<span class="wallet__currency-info">
										<span><?php echo e($walletDetails->name); ?></span>
										<span>SC</span>
									</span>
								</span>

								<span class="wallet__last-transactions">
									<span><?php echo e($walletDetails->todaySold); ?></span>
									<span>Last day</span>
								</span>
								...
								<span class="wallet__course">
									<span><?php echo e($walletDetails->solde); ?> SC</span>
									<span><?php echo e($walletDetails->solde *36); ?>  €</span>
								</span>
							</span>
                        ...
                        <span class="wallet__footer">
								...
								<span><b>Wallet number:</b> <span id="post-shortlink"><?php echo e($walletDetails->num_wallet); ?></span></span>
                ...
                <div class="wallet-inner__col">
                    <section class="transactions">
                        <h3><?php echo e($walletDetails->name); ?> transactions</h3>
                        ...
                        <button class="btn btn--blue" onclick="location.href='<?php echo e(url('/transactions')); ?>'">All transactions</button>
                    </section>
                </div>
            </div>
        </main>
    ...
    <div id="popup-edit-wallet"  class="mfp-container mfp-inline-holder d-none"><div class="mfp-content">
            <form class="form-prevent-multiple-submits popup popup-add-wallet zoom-anim-dialog" enctype="multipart/form-data" action="<?php echo e(action('WalletController@editWalletName', [$walletDetails->num_wallet])); ?>" method="POST" id="add-wallet">
                <div class="popup__content">
                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                    <h3>Change wallet name</h3>
                    <div class="popup-add-wallet__row">
                        <div class="input-wrap">
                            <input type="text" required="required" maxlength="10" name="wallet-new-name" value="<?php echo e($walletDetails->name); ?>">
                        </div>
                    </div>
    ...
    <div id="popup-send-supcash" class="mfp-container mfp-inline-holder d-none"><div class="mfp-content">
            <form class="popup popup-sent-currency zoom-anim-dialog form" autocomplete="off" enctype="multipart/form-data" action="<?php echo e(action('WalletController@sendSupCash')); ?>" method="POST"  id="sent-currency">
                <div class="popup__content">
                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                    <input type="hidden" name="walletNumber" value="<?php echo e($walletDetails->num_wallet); ?>">
                    ...
                    <div class="form__row">
                        <select class="custom-select" style="display: none;">
                            <option value="SupCash"><?php echo e($walletDetails->name); ?></option>
                        </select>
                    </div>
                    ...
                    <div class="exchange__col">
                        <div class="group-input">
                            <input id="getcurrency" required="required" min=0 max="<?php echo e($walletDetails->solde); ?>" name="scCurrencyToSend" type="number" step='0.01' placeholder="0.0">
