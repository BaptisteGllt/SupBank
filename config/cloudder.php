...
return [
    ...
    */
    ...
    'baseUrl'    => env('CLOUDINARY_BASE_URL', 'http://127.0.0.1:8000/'.env('CLOUDINARY_CLOUD_NAME')),
    'secureUrl'  => env('CLOUDINARY_SECURE_URL', 'https://127.0.0.1:8000/'.env('CLOUDINARY_CLOUD_NAME')),
